...
int main() {
  ...
  // also leaking: %x
  int ml = ft_printf(
      "Teasdasdasdsdst! %%%%%%%%%%%%%%%% %% %d %d %s %%%%%%%% Das ist ziemlich "
      "cool! %% %% %% test mich %u %i %p %x %s %d %p %p \n",
      int1, int2, "TEST ME", int3, int4, testpointer, int4, NULL, 4, NULL,
      NULL);
  int pl =
      printf("Teasdasdasdsdst! %%%%%%%%%%%%%%%% %% %d %d %s %%%%%%%% Das ist "
  ...
  int ml9 = ft_printf("!!%d %% %s %u %p \n", -123123, emptystring,
                      (unsigned int)4294967295, emptystring);
  ...
  if (c_sys == c_ft)
    printf(
        "\033[0;32m ALL 44 TEST PASSED! The mandatory part should be correct.");
  else
